...
// Load apartments from localStorage or return default
function loadApartments() {
  try {
    ...
    console.warn("Could not load saved apartments:", e);
  }
...
export default function RentWise() {
  ...
  const [apartments, setApartments] = useState(loadApartments);
  ...
  useEffect(() => {
    try {
      localStorage.setItem("rentwise-apartments", JSON.stringify(apartments));
    } catch (e) {
      console.warn("Could not save apartments:", e);
    }
  }, [apartments]);
