      ...
      <header style={{ position: "relative", overflow: "hidden", padding: isMobile ? "28px 18px 22px" : "52px 40px 38px", background: "linear-gradient(135deg, #fbeaef 0%, #f6d5df 100%)" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 960, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            ...
            }} style={{ background: "rgba(255,255,255,0.6)", border: "1px solid var(--rose-200)", borderRadius: 8, padding: isMobile ? "5px 10px" : "6px 12px", cursor: "pointer", fontSize: isMobile ? 10 : 12, fontFamily: "'DM Sans', sans-serif", color: "var(--rose-700)", fontWeight: 500, display: "flex", alignItems: "center", gap: 4, whiteSpace: "nowrap" }}>
